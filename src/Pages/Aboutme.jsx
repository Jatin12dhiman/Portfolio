...
const Aboutme = () => {
    return (
        <section id="about" className="bg-gray-800 py-20 px-8 md:px-24 text-white">
                ...
                <div className="md:flex md:items-start">
                    <div className="md:w-full">
                        ...
                        <div className="mt-8 text-center md:text-left">
                            <a href="#contact" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded transition duration-300 inline-block">
                                Contact Me
                            </a>
                        </div>
                    </div>
