            ...
            <div className='flex justify-between items-center p-18'>
               ...
               <div className={`absolute left-0 bg-blue-400 text-shine top-[64px] w-full flex flex-col p-4  items-center text-lg rounded-xl md:flex md:flex-row md:justify-evenly font-bold text-gray-900 md:opacity-100 md:relative md:top-0 ${Open ? 'top-15 opacity-100':'top-[-490px] opacity-0 '} `} >
                    <ul className='bg-blue-400 transition-all duration-100  flex flex-col items-center gap-6 md:flex-row md:gap-8 p-4'>
                        <li className='hover:text-gray-100 hover:text-[22px] duration-200 cursor-pointer text-xl'>Home</li>
                        <li className='hover:text-gray-100 hover:text-[22px] duration-200 cursor-pointer text-xl'>About</li>
                        <li className='hover:text-gray-100 hover:text-[22px] duration-200 cursor-pointer text-xl'>Project</li>
                        <li className='hover:text-gray-100 hover:text-[22px] duration-200 cursor-pointer text-xl'>Skills</li>
                        <li className='hover:text-gray-100 hover:text-[22px] duration-200 cursor-pointer text-xl'>Contact</li>
                    </ul>
                </div>
